<%-- 
    Document   : admin-aracsorgu
    Created on : 7 Ara 2023, 14:05:45
    Author     : yetun
--%>
    ...
    <body>    
        <%
            ...
            if (kontrol == null || !kontrol.equals("true")) {
                response.sendRedirect("admin-pagelogin.jsp");
            } else {
...
<%@include file="admin-menu.jsp" %>
    <div class="container-lg">
        ...
        <%
            try {
                // Aynı bağlantıyı tekrar kullanabilirsiniz
